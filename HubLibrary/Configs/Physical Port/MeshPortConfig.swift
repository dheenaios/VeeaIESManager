...
public struct MeshPortConfig: TopLevelJSONResponse, Equatable, Codable {
    ...
    public static func == (lhs: MeshPortConfig, rhs: MeshPortConfig) -> Bool {
        return lhs.ports == rhs.ports
    }
}

extension MeshPortConfig: ApiRequestConfigProtocol {
    public static func getTableName() -> String {
        return DbMeshPortConfig.TableName
    }
    ...
    public func getHubApiUpdateJSON() -> SecureUpdateJSON {
        ...
        json[MeshPortConfig.getTableName()] = vals
