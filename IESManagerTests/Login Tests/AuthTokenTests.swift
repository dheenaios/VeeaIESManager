...
class AuthTokenTests: XCTestCase {
    ...
    let urlString = "https://qa-auth.veea.co/auth/realms/veea/protocol/openid-connect/token"
    ...
    func test_getDataClosure() {
        ...
        let expectation = expectation(description: "AuthTokenTests_Get mocked group call response")
