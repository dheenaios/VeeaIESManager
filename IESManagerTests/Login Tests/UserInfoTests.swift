...
class UserInfoTests: XCTestCase {
    ...
    let urlString = "https://qa-auth.veea.co/auth/realms/veea/protocol/openid-connect/userinfo"
    ...
    func test_getDataClosure() {
        ...
        let expectation = expectation(description: "UserInfoTests_Get mocked group call response")
